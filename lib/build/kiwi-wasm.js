var kiwi = (() => {
    ...
    return (async function (moduleArg = {}) {
        ...
        async function createWasm() { function receiveInstance(instance, module) { wasmExports = instance.exports; wasmMemory = wasmExports["H"]; updateMemoryViews(); wasmTable = wasmExports["K"]; removeRunDependency("wasm-instantiate"); return wasmExports; } addRunDependency("wasm-instantiate"); function receiveInstantiationResult(result) { return receiveInstance(result["instance"]); } var info = getWasmImports(); if (Module["instantiateWasm"]) {
        ...
        var wasmImports = { a: ___cxa_throw, h: ___syscall_fcntl64, E: ___syscall_fstat64, t: ___syscall_ioctl, C: ___syscall_newfstatat, j: ___syscall_openat, D: ___syscall_stat64, u: __abort_js, g: __embind_register_bigint, l: __embind_register_bool, d: __embind_register_constant, F: __embind_register_emval, k: __embind_register_float, n: __embind_register_function, c: __embind_register_integer, b: __embind_register_memory_view, G: __embind_register_std_string, f: __embind_register_std_wstring, m: __embind_register_void, o: __emval_decref, s: __emval_incref, A: __emval_new_cstring, x: __mmap_js, y: __munmap_js, q: __tzset_js, p: _emscripten_get_heap_max, v: _emscripten_resize_heap, z: _environ_get, B: _environ_sizes_get, e: _fd_close, r: _fd_read, w: _fd_seek, i: _fd_write };
        ...
        var _emscripten_builtin_memalign = wasmExports["N"];
        Module["FS"] = FS;
